...
import { getProjectByPrefix, getProjectItems, loadProjectCharacters, loadProjectSituations, loadProjects } from './project/shared.js?v=situation-hard-delete-20260818a';
/**
...
function logInpaintFlow(stage, details = {}) {
    ...
    window.logFlowToStorage(`inpaint_${stage}`, {
        ...
        drawMode: window.INPAINT_DRAW_MODE || '',
